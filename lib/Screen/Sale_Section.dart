...
class StateSection extends State<Sale_Section> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () async {
        context.read<ProductDetailProvider>().setListType(true);
        return true;
      },
      child: Scaffold(
        key: scaffoldKey,
            ...
            children: [
              ...
              Expanded(
                child: Stack(
                  ...
                  selector: (_, ProductDetailsProvider) => ProductDetailsProvider.listType,),
          ...
          child: Row(
            ...
            children: [
              ...
              InkWell(
                ...
                onTap: () {
                  context.read<ProductDetailProvider>().setListType(!context.read<ProductDetailProvider>().listType);
                  context.read<ProductDetailProvider>().listType ?  listViewIconController.reverse() : listViewIconController.forward();
                },
              ),
            ],
          ),
                          ...
                          children: [
                            Row(
                              ...
                              children: <Widget>[
                                Hero(
                                  tag:
                                  "SaleList$index${widget.section_model!
                                                            ...
                                                            itemBuilder:
                                                              ...
                                                              return model
                                                                ...
                                                                return PopupMenuItem(
                                                                    child: Text(
                                                                        value,style: TextStyle( color: Theme.of(context).colorScheme.fontColor,),),
                                                                    value: value);
                                                              }).toList();
                                                            },
                                                          ),
    ...
    if (_isNetworkAvail) {
      if (CUR_USERID != null) {
        ...
        if (from == 1) {
          ...
          if (int.parse(qty) > model.itemsCounter!.length) {
            // qty = productList[index].minOrderQuntity.toString();

            setSnackbar('Max Quantity is-${int.parse(qty) - 1}');
          } else {
            db.updateCart(
                      ...
                      child: widget.section_model!.filterList != null
                          ...
                          itemBuilder: (context, index) {
                            if (index == 0) {
                              ...
                              attListId = widget
                                  .section_model!.filterList![index]
                                  .attributeValId!
                                  .split(',');
                      ...
                      Expanded(
                          child: Stack(
                            ...
                            children: [
                              Hero(
                                tag:
                                "SaleGrid${widget.sectionList![widget.index!]
                                    .productList![index].id}${widget
                                    .index}$index",
                                child: ClipRRect(
                                  borderRadius: const BorderRadius.only(
                                  ...
                                  child: FadeInImage(
                                    ...
                                    fit: extendImg ? BoxFit.fill : BoxFit
                                        .contain,
                                    imageErrorBuilder:
                                        (context, error, stackTrace) =>
                                        erroWidget(width),
