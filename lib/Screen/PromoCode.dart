...
class StatePromoCode extends State<PromoCode> with TickerProviderStateMixin {
  ...
  Future<Null> getPromoCodes() async {
    _isNetworkAvail = await isNetworkAvailable();
    if (_isNetworkAvail) {
      try {
        var parameter = {
        ...
        print("param promo****$parameter*****$getPromoCodeApi");
        Response response =
            await post(getPromoCodeApi, headers: headers, body: parameter)
                .timeout(Duration(seconds: timeOut));

        print("res sta****${response.statusCode}");
        if (response.statusCode == 200) {
          ...
          if (!error) {
            ...
            if ((offset) < total) {
              ...
              print("promoList len***${promoList.length}");
                                                                      ...
                                                                      Container(
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            onTap:
                                                                                () {
                                                                              Clipboard.setData(new ClipboardData(text: promoList[index].promoCode!));
