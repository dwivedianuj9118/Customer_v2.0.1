...
class StatePreview extends State<ReviewPreview> {
  ...
  Widget build(BuildContext context) {
    ...
    if(widget.productModel != null){
      model =
      widget.productModel!.reviewList![0].productRating![revImgList[curPos!].index!];
    }

    return Scaffold(
        body: Hero(
          //tag: "${widget.index}${widget.productModel!.id}",
          tag: "${widget.index}",
          child: Stack(
                ...
                builder: (BuildContext context, int index) {
                  ...
                  return PhotoViewGalleryPageOptions(
                      ...
                      CachedNetworkImageProvider(
                          ...
                          revImgList[index].img! : widget.imageList![index]));
                },
                itemCount:  widget.productModel != null ?
                revImgList.length : widget.imageList!.length,
