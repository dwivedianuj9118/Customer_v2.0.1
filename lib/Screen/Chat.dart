...
class _ChatState extends State<Chat> {
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: Text(capitalize(message.name!),
                    style:
                    const TextStyle(color: colors.primary, fontSize: 12)),
              )
            ],
          ),
        ),
  ...
  Future<void> sendMessage(String message) async {
    ...
    for (int i = 0; i < files.length; i++) {
      ...
      var pic = await http.MultipartFile.fromPath(ATTACH, files[i].path,contentType: MediaType('image', extension[1]),);
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      InkWell(
                        onTap: () {
                          _requestDownload(
                                attach[index].media, message.id, snapshot);
                        },
                        child: type == 'image'
                            ? Image.network(file,
                            width: 250,
