                  ...
                  ? ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        if (index == 0) {
                          ...
                          print("type is ${filterList[index]['attribute_values']}");
                          print("type is ${filterList[index]['swatche_type']}");
                          print("type is ${filterList[index]['swatche_value']}");
                          for (int i = 0; i < att.length; i++) {
                            print("length is ${att.length}");
                            print("length is ${attSType.length}");
                            Widget itemLabel;
                            if (attSType[i] == '1') {
