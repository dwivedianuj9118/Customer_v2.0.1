...
class Product {
  ...
  Product(
      ...
      this.seller_name,
      this.seller_id,
      this.store_name,this.is_attch_req});
  ...
  factory Product.fromJson(Map<String, dynamic> json) {
    ...
    List<String> items = List<String>.generate(
        json[TOTALALOOW] != null && json[TOTALALOOW] != ''? int.parse(json[TOTALALOOW]) : 10, (i) {
    ...
    if (reviewImg == null || reviewImg.isEmpty) {
      ...
      reviewList =
          reviewImg.map((data) => ReviewImg.fromJson(data)).toList();
    }
